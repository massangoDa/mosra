...
export const createCase = async (req: Request<{ customerId: string }>, res: Response) => {
    try {
...
export const getCases = async (req: Request<{ customerId: string }>, res: Response) => {
    try {
        const userId = req.user.id;
        const customerId = new ObjectId(req.params.customerId);
...
export const getCase = async (req: Request<{ customerId: string, caseId: string }>, res: Response) => {
    try {
        const userId = req.user.id;
        const customerId = new ObjectId(req.params.customerId);
...
export const updateCase = async (req: Request<{ customerId: string, caseId: string }>, res: Response) => {
    try {
        const customerId = new ObjectId(req.params.customerId);
        const caseId = new ObjectId(req.params.caseId);
        const userId = req.user.id;
...
export const deleteCase = async (req: Request<{ customerId: string, caseId: string }>, res: Response) => {
    try {
        const userId = req.user.id;
        const customerId = new ObjectId(req.params.customerId);
        const caseId = new ObjectId(req.params.caseId);
